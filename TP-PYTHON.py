...
tk.Label(fen, text="Entrez le premier nombre :", bg="#000000").grid(row=1, column=0, padx=10, pady=10, sticky="w")
entry_a = tk.Entry(fen, font=("Helvetica", 12))
entry_a.grid(row=1, column=1, padx=10, pady=10)
tk.Label(fen, text="Entrez le deuxième nombre :", bg="#000000").grid(row=2, column=0, padx=10, pady=10, sticky="w")

entry_b = tk.Entry(fen, font=("Helvetica", 12))
entry_b.grid(row=2, column=1, padx=10, pady=10)
tk.Button(fen, text="Résultat", command=main, font=("Helvetica", 12), bg="#007BFF", fg="white", relief="raised").grid(row=4, column=0, columnspan=2, pady=20)
